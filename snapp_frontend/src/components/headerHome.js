...
const HeaderHome = () => {
  ...
  return (
    ...
    >
      <div
        className="container bg-light rounded h-75"
        style={{
          background:
            "url(./assets/images/hero-image.png) 0 50% no-repeat fixed",
        }}
      >
        <div className="row">
          {/* <div className="col-md-6">
              <img className="img-fluid" src="./assets/images/p1.png" alt="" />
            </div>  */}
          <div className="bg-transparent py-5 col-md-6 d-flex flex-column justify-content-center align-items-center">
            {/* <!-- login --> */}
            <section className="d-flex mb-5">
              <Link
                to="/login"
                className="btn text-white px-4 mx-3"
                style={{ backgroundColor: "#ff00a6" }}
              >
                ورود
              </Link>
              <Link
                to="register"
                className="btn px-4"
                style={{ border: "1px solid #ff00a6", color: "#ff00a6" }}
              >
                ثبت نام
              </Link>
            </section>
            ...
            <h2 className="d-inline mt-3 mb-5">سفارش آنلاین غذا</h2>
            ...
            <div className="col-md-8 col-lg-8">
              <div className="input-group mb-3">
                <input
                  ...
                  placeholder="جستجوی غذای مورد نظر"
          ...
          <div className="col-md-6 rounded"></div>
        </div>
      </div>
    </div>
  );
